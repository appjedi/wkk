...
$db = new Database(1);
/*
INSERT INTO `videos` (`id`, `dateOfVideo`, `title`, `url`, `entered`, `status`, `sort_order`, `hostedBy`, `event_id`, `section`) 
    VALUES (2, '2018-07-04', 'Fourth of July 2018 Part 1', 
    'https://www.youtube.com/embed//zIDKvB64MmY?html5=1&amp;wmode=transparent', '2019-12-25 20:49:37', 0, 0, 1, 0, 1)
 
(10, '2019-05-16', 'Spring 2019 Promotional, Zac gets Sensei belt', 'https://www.facebook.com/facebook/videos/1235776939936850/', '2019-12-25 22:10:31', 1, 7, 0, 20200401, 1)

$insert = "INSERT INTO `videos` (`dateOfVideo`, `title`, `url`, `entered`, `status`, `sort_order`, `hostedBy`, `event_id`, `section`) 
    VALUES ('$dateOfVideo', '$title', '$url', '$entered', '$status', $sort_order, '$hostedBy', '$event_id', $section)";
 * 
 */
